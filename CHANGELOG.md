...
* **desktop:** {/} jump between comments in diff view ([1181959](https://github.com/josephschmitt/monocle/commit/1181959127d59522faae305618f49746888cf724))
* **desktop:** add comment editor, review submission, and review actions ([41ddb73](https://github.com/josephschmitt/monocle/commit/41ddb7383442d50e8ebfadf6938ae5f20a1e51ef))
* **desktop:** add connection info, history, and base ref picker dialogs ([2ba1bc6](https://github.com/josephschmitt/monocle/commit/2ba1bc6ba1145b8731cda29952acb9c08ef0cf20))
* **desktop:** add diff view keyboard navigation and fix shift key matching ([10b3892](https://github.com/josephschmitt/monocle/commit/10b389296f87825304c5caae46c43f9b48f954e0))
* **desktop:** add diff view with react-diff-view and content viewer ([7b7914a](https://github.com/josephschmitt/monocle/commit/7b7914ade6129b034ecfff46ff7416cec8b5477e))
* **desktop:** add Enter/dir toggle, tree collapse/expand, and Ctrl+Y copy ([7b81a08](https://github.com/josephschmitt/monocle/commit/7b81a0854e2d6e0bab00536fbfdf645ce6f6aa55))
* **desktop:** add File &gt; Open Project menu for switching projects ([de66a67](https://github.com/josephschmitt/monocle/commit/de66a67db5e9410eeb84f5ac44900ee28a7a82d7))
* **desktop:** add full splash screen matching TUI empty state ([904e690](https://github.com/josephschmitt/monocle/commit/904e69023b968b1c8818aac6a3bc06328f316a23))
* **desktop:** add help dialog, command palette, and remaining keyboard shortcuts ([fb4cd80](https://github.com/josephschmitt/monocle/commit/fb4cd808e9d78c2929427af73260fc10c1c9a8b5))
* **desktop:** add layout shell, sidebar, keyboard nav, and API layer ([395c7af](https://github.com/josephschmitt/monocle/commit/395c7afde0bd8249ede49b56856f96f78e6829d1))
* **desktop:** add macOS-native frameless window with toolbar and refined sidebar ([85bd823](https://github.com/josephschmitt/monocle/commit/85bd82306bff7fc62a1bd18bac003c6e3fc949a9))
* **desktop:** add missing keybindings for TUI feature parity ([b40020c](https://github.com/josephschmitt/monocle/commit/b40020ce1339ba866bd5f3b7e47b980ea6337141))
* **desktop:** add Nerd Font file icons in sidebar ([ae897e7](https://github.com/josephschmitt/monocle/commit/ae897e7feda0b0e8ce9a62f7e092621fb9b9ec03))
* **desktop:** add project picker for directory selection ([fe93959](https://github.com/josephschmitt/monocle/commit/fe9395981673a9995978fbc6c0820ab7bec261b7))
* **desktop:** add project switcher dropdown to toolbar ([e42c939](https://github.com/josephschmitt/monocle/commit/e42c9392923d6993fb629cbf01e08d917424c216))
* **desktop:** add syntax highlighting to diff view ([eb59776](https://github.com/josephschmitt/monocle/commit/eb5977610bd55c6e4818f284b0c8363fa64db376))
* **desktop:** add visual selection, click-to-focus, and drag-to-select ([b357f15](https://github.com/josephschmitt/monocle/commit/b357f15f218d04cb246236b5b2d80bc0f2222f19))
* **desktop:** add website-matched typography and visual polish ([ea484c3](https://github.com/josephschmitt/monocle/commit/ea484c35df46a7e66b757ce51acbe920a2220f13))
* **desktop:** auto-select plans when received and fix null hunks crash ([1e4cee1](https://github.com/josephschmitt/monocle/commit/1e4cee17b933f94a42ddecc48bd8c27462f4587f))
* **desktop:** improve base ref picker and show current ref in status bar ([1065c54](https://github.com/josephschmitt/monocle/commit/1065c54df53449ecc6b9820b6b6e3a65d5eed464))
* **desktop:** make comments navigable with j/k cursor movement ([fb92a4e](https://github.com/josephschmitt/monocle/commit/fb92a4e6165451f8c94e5d1cd51980e1ae0813f1))
* **desktop:** match TUI connection indicator states in toolbar ([0eb18c7](https://github.com/josephschmitt/monocle/commit/0eb18c7c7d1c83d6acaf02791c8ea33b4f8072a2))
* **desktop:** move logotype next to traffic lights using JetBrains Mono ([2d37fbb](https://github.com/josephschmitt/monocle/commit/2d37fbbd0bab50940af038dcb9f27f365defc13d))
* **desktop:** press c on focused comment to edit it ([db6f872](https://github.com/josephschmitt/monocle/commit/db6f8720b5ea3aec434be82bf014093efc48e602))
* **desktop:** render file-level comments at top of diff view ([dfa6af9](https://github.com/josephschmitt/monocle/commit/dfa6af936819febe8cc8e7a001e2b18ef9195ad8))
* **desktop:** render plans and files through DiffView with full navigation ([ed163c7](https://github.com/josephschmitt/monocle/commit/ed163c7ef03feb13f2548e6f8f3ed9d5121b7cb4))
* **desktop:** render suggestion comments as inline diffs ([e8d251a](https://github.com/josephschmitt/monocle/commit/e8d251a55b26351ee669f1394bc3a9057d21ac4c))
* **desktop:** replace border focus indicators with accent bars and kill native outlines ([2e1cb77](https://github.com/josephschmitt/monocle/commit/2e1cb77d7ff2b95f5d3345ea7983639f2f96ecf7))
* **desktop:** reposition macOS traffic lights to align with toolbar ([7f4c761](https://github.com/josephschmitt/monocle/commit/7f4c76183970c61a63dc394da9079a6fb7954121))
* **desktop:** show empty circle for unreviewed files in sidebar ([2afe95c](https://github.com/josephschmitt/monocle/commit/2afe95c38495a6ccfcc2aa5e0c1f5790898e7bc2))
* **desktop:** switch to Shiki for diff syntax highlighting ([b763bd8](https://github.com/josephschmitt/monocle/commit/b763bd85ba6e1f65eafef98aad6bf433f00533e1))
* **desktop:** update help dialog with all TUI-parity keybindings ([a8ae93c](https://github.com/josephschmitt/monocle/commit/a8ae93ce65d3dbdc89e5810076efafefe4af68a7))
* scaffold Wails desktop app with React frontend ([57c9965](https://github.com/josephschmitt/monocle/commit/57c9965056e78d5b4667368a2d5a930cf69f8cd2))


### Bug Fixes

* **ci:** bundle MCP channel before desktop builds ([5cca634](https://github.com/josephschmitt/monocle/commit/5cca634a409efb2274f36e800cfca40f96c19164))
* **ci:** replace macos-13 matrix with cross-compilation on macos-latest ([bb4bee5](https://github.com/josephschmitt/monocle/commit/bb4bee54a646eab5626b6850c06335d291cb82fa))
* **ci:** simplify desktop release to arm64-only build ([1f51286](https://github.com/josephschmitt/monocle/commit/1f51286b2e3d9b71368b996ff682146e1559b0f3))
* **desktop:** align git status left and review checkmark right in sidebar ([d156210](https://github.com/josephschmitt/monocle/commit/d156210a3a9c85a247d4b6213affd63208442b38))
* **desktop:** cursor movement now triggers file selection ([2be5662](https://github.com/josephschmitt/monocle/commit/2be5662841db2af845f15e05174c44bc5e163829))
* **desktop:** dim selection highlights in unfocused panes ([7c62a22](https://github.com/josephschmitt/monocle/commit/7c62a22e57f1f734790252fe270d1a0b21649206))
* **desktop:** downgrade refractor to v4 for react-diff-view compat ([8a72c74](https://github.com/josephschmitt/monocle/commit/8a72c745bd0c272bb68aa47b2aa7c5062e3f46c6))
* **desktop:** fix base ref picker footer overlap and scroll overflow ([3d27a12](https://github.com/josephschmitt/monocle/commit/3d27a12eb7c2a74dc94574aa85fd0e111c254253))
* **desktop:** fix connection indicator by tracking queue mode ([20a1085](https://github.com/josephschmitt/monocle/commit/20a1085387b734d026a35ef2314200a1092e5e97))
* **desktop:** isolate dev DB path and guard nil database in SelectProject ([e2958ac](https://github.com/josephschmitt/monocle/commit/e2958ac9ad6553295b60cdb0e2ae22234dbacde5))
* **desktop:** load config on startup to apply user preferences ([097a2c9](https://github.com/josephschmitt/monocle/commit/097a2c9f5a5417c9917b1896bdcbe0d519c35eee))
* **desktop:** load react-diff-view CSS before Catppuccin overrides ([203a6a6](https://github.com/josephschmitt/monocle/commit/203a6a6baf180c828fe1e88d86fa780b1031877a))
* **desktop:** make sidebar full-height and add status bar padding ([995033f](https://github.com/josephschmitt/monocle/commit/995033f623a2b77e761d533b8241945064f42251))
* **desktop:** move git status badge to left of file icon in sidebar ([34e6fe4](https://github.com/josephschmitt/monocle/commit/34e6fe472acaa8115efdcabd01711d37370fd0ba))
* **desktop:** pass structural tokens so renderToken fires for Shiki ([a36ac86](https://github.com/josephschmitt/monocle/commit/a36ac86e0de95ef164bdf4f18c88b6a987f3312f))
* **desktop:** pre-fill suggestion block with selected line content ([94f0603](https://github.com/josephschmitt/monocle/commit/94f060383b4845ccf74d8a430dfc91e248eb10cc))
* **desktop:** prevent duplicate comment widgets on modified lines ([5a8a23f](https://github.com/josephschmitt/monocle/commit/5a8a23fdb9f6768c2065c96f767c996c34910f29))
* **desktop:** reduce sidebar item font size from text-sm to text-xs ([c1a9a22](https://github.com/josephschmitt/monocle/commit/c1a9a221cfd9c812107c4452ab60be46fc69c5dd))
* **desktop:** refresh changed files after base ref selection ([b55a70b](https://github.com/josephschmitt/monocle/commit/b55a70b346557fbd7b0fbdbd16b2d57e183ec4ad))
* **desktop:** remove fixed width on sidebar icons to prevent overlap ([7770235](https://github.com/josephschmitt/monocle/commit/7770235b333de084e6c82a1078adb0fe7b8ae80c))
* **desktop:** return value from SelectProject for Wails binding compat ([3e881ac](https://github.com/josephschmitt/monocle/commit/3e881ac8caa531bbff5c1bb8c5ab0a650daac930))
* **desktop:** scope dev-mode watcher to desktop-relevant directories ([b367ebd](https://github.com/josephschmitt/monocle/commit/b367ebd736c85de0a456c085ead6c80f78b3cb0e))
* **desktop:** show ⌘ instead of Ctrl on Mac for keyboard hints ([34f18e4](https://github.com/josephschmitt/monocle/commit/34f18e4919b4835d2a00f252af042d80e850fb94))
* **desktop:** show logotype and Focus Mode badge in toolbar when sidebar hidden ([29b7af6](https://github.com/josephschmitt/monocle/commit/29b7af63a07d7acb13bc434b4db55d822fb727ef))
* **desktop:** simplify Makefile build targets ([ada3ae8](https://github.com/josephschmitt/monocle/commit/ada3ae8ef47392198839381fd7e194d202a44067))
* **desktop:** skip folders when navigating files with [/] ([2044dbe](https://github.com/josephschmitt/monocle/commit/2044dbef15c19f3d4a239d38f706e221fc3ed2f4))
* **desktop:** sort sidebar tree directories-first then alphabetical ([ebab396](https://github.com/josephschmitt/monocle/commit/ebab39635269024532be95d143302dbb81bc34bc))
* **desktop:** suppress file active highlight when cursor is on a folder ([778ba47](https://github.com/josephschmitt/monocle/commit/778ba47af6d8e1b9ee1c7600eee06b4978e8df6d))
* **desktop:** surface project selection errors in picker ([91c69fe](https://github.com/josephschmitt/monocle/commit/91c69fe2a8db21826f42e555124f5dcd4e3fe5c5))
* **desktop:** update empty state to match TUI splash screen ([8098ac0](https://github.com/josephschmitt/monocle/commit/8098ac04bd3e2bee6dd04d2597e59a7b6a2becf5))
* **desktop:** use bundled PureNerdFont for file icons ([64a0a9c](https://github.com/josephschmitt/monocle/commit/64a0a9c9f1150ae0a6cb79d5bee703fa027af707))
* **desktop:** use monospace font in comment textareas and fix dev setup ([aad3505](https://github.com/josephschmitt/monocle/commit/aad35054c3f1e27ecd8fa07728ce2b82dd38d812))
* **desktop:** use Nerd Font family for sidebar file icons ([213687f](https://github.com/josephschmitt/monocle/commit/213687fc5708d904905a129070eb406c625e5703))
* **desktop:** use nerd font folder icon matching TUI sidebar ([18be01b](https://github.com/josephschmitt/monocle/commit/18be01bb48536471326606e3669dd347bad630ad))
* **desktop:** use same highlight color for cursor and active sidebar items ([a873db0](https://github.com/josephschmitt/monocle/commit/a873db0eb3be9d278fdfb93c6caeffb01eee7634))
* **desktop:** use solid fill color for focused comment highlight ([7b73bc8](https://github.com/josephschmitt/monocle/commit/7b73bc8cf3974405a26f89ef0a0bf26860296eb2))
* **desktop:** use vibrant color for focused comment highlight ([45a1334](https://github.com/josephschmitt/monocle/commit/45a1334ce6293ee2635ead2ee87d924f22b7784d))
* **desktop:** widen comment and submit modals to max-w-2xl ([6baa54a](https://github.com/josephschmitt/monocle/commit/6baa54a28d7a4e583276bcca88bafb8b3b389c97))
* **desktop:** wrap around when jumping between comments with {/} ([b6a11f1](https://github.com/josephschmitt/monocle/commit/b6a11f125e9ff4e8550a7bad3f65244ae3c73a94))
* make vet depend on frontend-dist so go vet works without a prior desktop build ([88f2b0c](https://github.com/josephschmitt/monocle/commit/88f2b0cc89da501b3645532777a082ede42d629f))
